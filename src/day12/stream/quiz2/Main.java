...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Double> price2022 = bookings.stream()
                .filter(b -> b.getYear() == 2022)
                .map(Booking::getPrice)
                .sorted()
                .collect(Collectors.toList());
        price2022.forEach(System.out::println);
        ...
        System.out.println("======================================");
        List<String> allCountry = bookings.stream()
        ...
        System.out.println("======================================");
        List<String> email = bookings.stream()
        ...
        System.out.println("======================================");
        List<Double> maxPrice = bookings.stream()
                .map(Booking::getPrice)
        ...
        Booking cheapestBooking = bookings.stream()
                ...
                .orElse(null);
        System.out.println("cheapestBooking = " + cheapestBooking);
        ...
        double maxPrice1 = bookings.stream()
                .mapToDouble(Booking::getPrice)
                .max()
                .orElse(0);

        double difference = maxPrice1- minPrice;
